/* Template: Aenfis School Course Online
   Author: Reactium
   Created: Sep 2020
...
(function($) {
    ...
    $("#clock")
        ...
        .on("update.countdown", function(event) {
            var format =
                '<span class="counter-number">%D<br><span class="timer-text">Días</span></span><span class="counter-number">%H<br><span class="timer-text">Horas</span></span><span class="counter-number">%M<br><span class="timer-text">Minutos</span></span><span class="counter-number">%S<br><span class="timer-text">Segundos</span></span>';
