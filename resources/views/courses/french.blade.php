...
<html lang="es">
  <head>
    ...
    <meta
      name="description"
      content="Curso de Francés online a meses desde tu casa en todos los horarios, clases personalizadas."
    />
    ...
    <!-- Website Title -->
    <title>Curso Online de Francés con 30 horas mensuales</title>
    ...
    <link href="css/french.css" rel="stylesheet" />
  ...
  <body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-container">
              ...
              <p class="p-large">
                Aprende con la metodología <strong>Steps</strong> en nuestro <strong>curso de Francés</strong> 100% en línea. 
            ...
            <div class="text-container">
              ...
              <ul class="list-unstyled li-space-lg">
                ...
                <li class="media">
                  <i class="fas fa-square"></i>
                  <div class="media-body">
                    <strong>Te ayudamos</strong> a preparar tu certificación DELF y DALF
                  </div>
                </li>
                <li class="media">
                  <i class="fas fa-square"></i>
    ...
    <div id="instructor" class="basic-1">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="text-container">
              <h2>Soy Viridiana Lozano</h2>
              <p>
                Tu profesora del <strong>curso de Francés</strong>, además de 
                las clases en vivo, revisaremos materiales de estudio día con día. 
                Cuento con más de 8 años de experiencia impartiendo webinars, seminarios
                y como profesor catedrático.
              </p>
              <p>
                Mi pasión es la enseñanza del idioma, en este <strong>curso online</strong> 
                de Francés, quiero guiarte para que te prepares para tu certificación DELF y DALF.
    ...
    <div id="description" class="basic-2">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2>Razones para estudiar Francés en línea</h2>
          </div>
          <!-- end of col -->
        </div>
        <!-- end of row -->
          ...
          <div class="col-lg-6">
            <ul class="list-unstyled li-space-lg first">
              <li class="media">
                <i class="bullet">1</i>
                <div class="media-body">
                  <h4>Materiales DEFI</h4>
                  <p>
                    Guias de estudio, trabajos y desarollo de las clases con DEFI.
                    La mejor opción para que en poco tiempo aprendas <strong>francés.</strong>
                  </p>
                </div>
              </li>
              <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                  ...
                  <p>
                    ...
                    en este <strong>curso de francés</strong> constantemente. 
                  </p>
                </div>
              </li>
            </ul>
            ...
            <ul class="list-unstyled li-space-lg second">
              <li class="media">
                ...
                <div class="media-body">
                  ...
                  <p>
                    La gramática es muy fácil utilizando los materiales <strong>Défi</strong>, 
                    escribir en francés te permitirá avanzar en tus objetivos.
                  </p>
                </div>
              </li>
              <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                  ...
                  <p>
                    ...
                    reducidos práctica tu <strong>dominio del francés</strong>. 
                  </p>
                </div>
              </li>
            </ul>
          ...
          <div class="col-lg-6">
            <div class="text-container">
              ...
              <p>
                ...
                Estuida en cualquier parte con este <strong>curso de francés</strong>.
              </p>
              <a
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p class="p-heading">
              ...
              con este curso de Francés 100% en línea.
            </p>
          </div>
          <!-- end of col -->
        </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p>
                  Mentoría para el examen de certificación en Delf & Dalf
                </p>
              </div>
            </div>
            <!-- end of card -->
              ...
              <div class="swiper-container text-slider">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="text-wrapper">
                      <div class="testimonial-text">
                        Tomé el curso de formación de Francés hace un año y
                        estoy muy contenta. Dos meses después trabajo en Paris.
                      </div>
                      <div class="testimonial-author">
                        Carla Moreno - Asafata Internacional
                      </div>
                    </div>
                    <!-- end of text-wrapper -->
                  </div>
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="text-wrapper">
                      <div class="testimonial-text">
                        Buscaba unas vacaciones con amigos, tomé el curso de francés y en
                        menos de 4 meses mi viaje ya está organizado.
                      </div>
                      <div class="testimonial-author">
                        Rodrigo Solano - Viajero Frecuente
                      </div>
                    </div>
                    <!-- end of text-wrapper -->
                  </div>
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="text-wrapper">
                      <div class="testimonial-text">
                        ...
                        nuestros clientes hablan Francés.
                      </div>
                      <div class="testimonial-author">
                        Miguel Rendón - Director de Turismo
                      </div>
                    </div>
                    <!-- end of text-wrapper -->
                  </div>
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="text-wrapper">
                      <div class="testimonial-text">
                        ...
                        envíos nacionales e internacionales gracias a este curso de francés.
                      </div>
                      <div class="testimonial-author">
                        Fernanda Mortell - Agente Aduanal
                      </div>
                    </div>
                    <!-- end of text-wrapper -->
                  </div>
          ...
          <div class="col-lg-12">
            <div class="text-container">
              ...
              <p>
                ...
                próxima sesión del Curso de Francés en vivo. Rellene el
