...
<head>
    ...
    <!-- Website Title -->
    <title>Política de Privacidad - Aenfis</title>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/politica-de-privacidad') }}"><span class="item-text">PRIVACY POLICY</span></a>
                    </div>
                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>When you first register for a Aenfis account, and when you use the Services, we collect some <a href="#your-link">Personal Information</a> about you such as:</p>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg">
                                    ...
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">A unique Aenfis user ID (an alphanumeric string) which is assigned to you upon registration should always be at front</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                    ...
                    <div class="text-container">
                        <h3>How We Use Aenfis Landing Page Data</h3>
                        <p>Aenfis Landing Page Template uses visitors' data for the following general purposes and for other specific ones that are important:</p>
                        <ol class="li-space-lg">
                            ...
                            <li>To sell or market Aenfis Landing Page products and services to you or in other parts of the world where legislation is less restrictive</li>
                    ...
                    <div class="text-container">
                        ...
                        <p>Aenfis is a HTML landing page template tool. By its nature, Services enable our customers to promote their products and services integrate with hundreds of business applications that they already use, all in one place. Customer security is our primary focus in this document.</p>
                    ...
                    <div class="text-container">
                        <h3>Consent Of Using Aenfis Landing Page</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="text-container last">
                                ...
                                <p>Aenfis Landing Page uses tracking technology on the landing page, in the Applications, and in the Platforms, including mobile application identifiers and a unique Aenfis user ID to help us. Recognize you across different Services, to monitor usage and web traffic routing for the Services, and to customize the Services.</p>
                                <p>By visiting Aenfis or using the Services you agree to the use of cookies in your browser and HTML-based emails. You visit a website, by using any of the Services, or submitting via the Services you consent and use of your basic <a href="#your-link">Personal Information</a></p>
                            </div> <!-- end of text container -->
                        </div> <!-- end of col-->
                        <div class="col-md-6">
                            ...
                            <div class="form-container">
                                <form id="privacyForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group checkbox">
                                        <input type="checkbox" id="pterms" value="Agreed-to-Terms" required>I have read and agree to Aenfis's <a href="{{ url('/politica-de-privacidad') }}">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
